  ...
  return (
    <>
      ...
      >
        ...
        <Paper sx={{ p: 1 }}>{connectionStatus.status ? <Typography color={green[400]} >連線成功</Typography> : connectionStatus.finished ? <Typography color={red[500]}>連線異常</Typography> : "正在測試"}{connectionStatus.message}</Paper>
        <p></p>
